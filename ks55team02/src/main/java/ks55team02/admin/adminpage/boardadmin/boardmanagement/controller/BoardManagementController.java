...
public class BoardManagementController {
	...
	public String viewBoardList(Model model) {
		List<Board> boardList = boardManagementService.selectBoardList();
	...
	@ResponseBody
	public ResponseEntity<Board> selectBoardDetails(@PathVariable String boardCode) {
		Board board = boardManagementService.selectBoardByCode(boardCode);
		if (board != null) {
	...
	public ResponseEntity<?> insertBoard(@RequestBody Board board,
		...
		try {
			...
			boardManagementService.insertBoard(board, adminUserNo); // Service에 관리자 번호 전달
