...
public interface PostManagementService {
     ...
     * @return 게시글 목록
     */
    List<AdminPost> getPostList(AdminPost searchCriteria);
     ...
     * @return 전체 게시글 개수
     */
    int getPostCount(AdminPost searchCriteria);
     ...
     * @return 처리된 행의 수
     */
    int hidePosts(List<String> postSns);
     ...
     * @return 처리된 행의 수
     */
    int restorePosts(List<String> postSns);
}