...
public interface CouponsService {
     ...
     */
    CustomerPagination<Coupons> getAvailableCoupons(String userId, String keyword, String sortOrder, int page);
     ...
     */
    CustomerPagination<UserCoupons> getMyCoupons(String userId, String keyword, String sortOrder, int page);

    /**
     * 사용자가 쿠폰을 발급받도록 처리합니다.
     * @param userId 쿠폰을 발급받을 사용자 아이디
     * @param couponId 발급받을 쿠폰의 ID
     * @return 쿠폰 발급 성공 여부 및 메시지
     */
    boolean issueCouponToUser(String userId, String couponId);
