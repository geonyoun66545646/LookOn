...
public class CustomerRegisterServiceImpl implements CustomerRegisterService {
 ...
 // 생성자를 통한 의존성 주입 (가장 권장되는 방식)
    ...
    public void joinUser(UserJoinRequest userJoinRequest) {
        ...
        // =========================================================================
        // TODO: [나중에 Security 적용 시 수정] 현재는 평문 비밀번호를 그대로 저장
        // 나중에는 passwordEncoder.encode(userJoinRequest.getUserPswd()) 코드로 변경
        // 사용자 비밀 번호
        user.setUserPswdEncptVal(userJoinRequest.getUserPswd());
        // =========================================================================
